...
const CARDS = [
  {
    ...
    body: 'They get a paycheck on a set schedule.',
    info: "W-2 employee. We'll ask what actually hits your account.",
    value: 'civilian',
  },
  {
    label: 'ACTIVE DUTY MILITARY',
    body: 'They receive a military paycheck.',
    info: "We'll reconstruct their full compensation as part of your household picture.",
    value: 'military',
  },
  {
    label: 'SELF-EMPLOYED OR VARIABLE',
    body: "Their income doesn't follow a set schedule.",
    info: "Freelance, contract, or inconsistent income. We'll use a realistic baseline.",
    value: 'selfEmployed',
  },
  {
    label: 'NO INCOME',
    body: "They're not currently earning income.",
    value: 'none',
  },
];

function PartnerIncomeScreen({ userData, updateUserData, onNext, onBack }) {
  const [mounted, setMounted] = useState(false);
  const [selected, setSelected] = useState(userData.partnerIncomeType ?? null);
  ...
  const handleContinue = () => {
    updateUserData({ partnerIncomeType: selected });
    onNext('incomeType');
  };
  ...
  return (
    <div style={{
      ...
      <p style={{
        ...
        We&rsquo;ll factor their income into the full picture.
      </p>
...
export default PartnerIncomeScreen;
