...
export function generateSaveCode(userData) {
  const slim = {
    ...
    ho: userData.housing, ut: userData.utilities, gr: userData.groceries,
    ...
    hi: userData.healthInsurance, md: userData.outOfPocketMedical,
    hsa: userData.hasHSA, su: userData.subscriptions, ch: userData.childcare,
    db: userData.debts, cl: userData.clothing, en: userData.entertainment,
...
export function decodeSaveCode(raw) {
  try {
    ...
    return {
      ...
      housing: slim.ho ?? null, utilities: slim.ut ?? null, groceries: slim.gr ?? null,
      diningOut: slim.do ?? null, carPayment: slim.cp ?? null, gasAndFuel: slim.gf ?? null,
      carInsurance: slim.ci ?? null, phone: slim.ph ?? null, internet: slim.in ?? null,
      healthInsurance: slim.hi ?? null, outOfPocketMedical: slim.md ?? null,
      hasHSA: slim.hsa ?? null, subscriptions: slim.su ?? [], childcare: slim.ch ?? null,
      debts: slim.db ?? [], clothing: slim.cl ?? null, entertainment: slim.en ?? null,
